...
## Import database Phase 5

Chạy từ chính folder `phase5-rbl` để import toàn bộ Phase 1 đến Phase 5 vào database `lucy_phase5`:
...
7. `database/phase5-stress-evaluation.sql`
...
SELECT COUNT(*) FROM cross_testing_reports;
```
...
File này đã gộp sẵn schema, seed, digitized content, Phase 2 realtime SQL, Phase 3 LMS SQL, Phase 4 monetization SQL và Phase 5 stress evaluation SQL nên chỉ cần chạy một lần trong SQL Editor của DBeaver.
